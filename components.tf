...
# resource "aws_imagebuilder_component" "optimize_image_component" {
#   name                  = "optimize-image-component"
#   platform              = "Linux"
#   version               = "1.0.0"
#   supported_os_versions = ["Amazon Linux 2023", "Ubuntu 22.04", "Ubuntu 20.04", "RHEL 8", "RHEL 9"]
#   data                  = file("./components/optimize-image.yaml")
...
#   version               = "1.0.0"
#   supported_os_versions = ["Amazon Linux 2023", "Ubuntu 22.04", "Ubuntu 20.04", "RHEL 8", "RHEL 9"]
#   data                  = file("./components/cloudwatch-agent.yaml")
...
#   version               = "1.0.0"
#   supported_os_versions = ["Amazon Linux 2023", "Ubuntu 22.04", "Ubuntu 20.04", "RHEL 8", "RHEL 9"]
#   data                  = file("./components/ssm-agent.yaml")
...
#   version               = "1.0.0"
#   supported_os_versions = ["Amazon Linux 2023", "Ubuntu 22.04", "Ubuntu 20.04", "RHEL 8", "RHEL 9"]
#   data                  = file("./components/efa-install.yaml")
...
#   version               = "1.0.0"
#   supported_os_versions = ["Amazon Linux 2023", "Ubuntu 22.04", "Ubuntu 20.04", "RHEL 8", "RHEL 9"]
#   data                  = file("./components/lustre-install.yaml")
...
#   version               = "1.0.0"
#   supported_os_versions = ["Amazon Linux 2023", "Ubuntu 22.04", "Ubuntu 20.04", "RHEL 8", "RHEL 9"]
#   data                  = file("./components/pcs-agent-install.yaml")
